...
--%>
<jsp:directive.include file="/WEB-INF/view/login/jsp/ui/includes/top.jsp" />

<%@ page import="com.haoyu.sip.login.web.support.WebUtils"%>
...
<jsp:directive.include file="/WEB-INF/view/login/jsp/ui/includes/bottom.jsp" />
