 ...
 * under the License.
 */
package com.haoyu.sip.login.auth.handler;
 ...
 * message digest that the JDK can accept, including MD5 and SHA1-1、SHA1-256. Returns the
