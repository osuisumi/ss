 ...
 * under the License.
 */
package com.haoyu.sip.login.ticket.registry.support;
...
import com.haoyu.sip.login.ticket.registry.LockingStrategy;
import com.haoyu.sip.login.ticket.registry.NoOpLockingStrategy;
import com.haoyu.sip.login.ticket.registry.RegistryCleaner;
 ...
 * {@link com.haoyu.sip.login.ticket.registry.JpaTicketRegistry}, for example.
 ...
 * should be used with {@link com.haoyu.sip.login.ticket.registry.JpaTicketRegistry}
...
public final class DefaultTicketRegistryCleaner implements RegistryCleaner {
    ...
    /**
     * @see com.haoyu.sip.login.ticket.registry.RegistryCleaner#clean()
     */
    public void clean() {
     ...
     * for {@link com.haoyu.sip.login.ticket.registry.JpaTicketRegistry} in a clustered
     * CAS environment.
     */
