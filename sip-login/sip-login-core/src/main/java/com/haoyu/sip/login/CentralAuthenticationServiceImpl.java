...
import com.haoyu.sip.login.auth.AcceptAnyAuthenticationPolicyFactory;
import com.haoyu.sip.login.auth.Authentication;
import com.haoyu.sip.login.auth.AuthenticationBuilder;
import com.haoyu.sip.login.auth.AuthenticationException;
import com.haoyu.sip.login.auth.AuthenticationManager;
import com.haoyu.sip.login.auth.ContextualAuthenticationPolicy;
import com.haoyu.sip.login.auth.ContextualAuthenticationPolicyFactory;
import com.haoyu.sip.login.auth.MixedPrincipalException;
import com.haoyu.sip.login.auth.Credential;
import com.haoyu.sip.login.auth.principal.PersistentIdGenerator;
import com.haoyu.sip.login.auth.principal.Principal;
import com.haoyu.sip.login.auth.principal.Service;
import com.haoyu.sip.login.auth.principal.ShibbolethCompatiblePersistentIdGenerator;
import com.haoyu.sip.login.auth.principal.SimplePrincipal;
import com.haoyu.sip.login.logout.LogoutManager;
import com.haoyu.sip.login.logout.LogoutRequest;
import com.haoyu.sip.login.services.RegisteredService;
import com.haoyu.sip.login.services.RegisteredServiceAttributeFilter;
import com.haoyu.sip.login.services.ServiceContext;
import com.haoyu.sip.login.services.ServicesManager;
import com.haoyu.sip.login.services.UnauthorizedProxyingException;
import com.haoyu.sip.login.services.UnauthorizedServiceException;
import com.haoyu.sip.login.services.UnauthorizedSsoServiceException;
import com.haoyu.sip.login.services.support.RegisteredServiceDefaultAttributeFilter;
import com.haoyu.sip.login.ticket.ExpirationPolicy;
import com.haoyu.sip.login.ticket.InvalidTicketException;
import com.haoyu.sip.login.ticket.QRCodeLoginTicket;
import com.haoyu.sip.login.ticket.QRCodeLoginTicketImpl;
import com.haoyu.sip.login.ticket.ServiceTicket;
import com.haoyu.sip.login.ticket.TicketException;
import com.haoyu.sip.login.ticket.TicketGrantingTicket;
import com.haoyu.sip.login.ticket.TicketGrantingTicketImpl;
import com.haoyu.sip.login.ticket.TicketValidationException;
import com.haoyu.sip.login.ticket.UnsatisfiedAuthenticationPolicyException;
import com.haoyu.sip.login.ticket.registry.TicketRegistry;
import com.haoyu.sip.login.util.UniqueTicketIdGenerator;
import com.haoyu.sip.login.validation.Assertion;
import com.haoyu.sip.login.validation.ImmutableAssertion;
...
public final class CentralAuthenticationServiceImpl implements CentralAuthenticationService {
     ...
     *  <li> If the {@link com.haoyu.sip.login.services.RegisteredService#getUsernameAttribute()} is blank, then the default
