 ...
 * @since 4.0.0
 */
public abstract class RootLoginException extends Exception {
   ...
   */
  public RootLoginException(final String code) {
      initException(code);
  }
   ...
   */
  public RootLoginException(final String code, final String msg) {
      super(msg);
      initException(code);
  }
   ...
   */
  public RootLoginException(final String code, final Throwable throwable) {
      super(throwable);
      initException(code);
  }
  ...
  public final String getCode() {
      ...
      if (cause != null && (cause instanceof RootLoginException)) {
        return ((RootLoginException) cause).getCode();
      }
      return this.code;
  }
