                        ...
                        <div class="mis-column-innerL">
             			...
             			<div class="mis-column-innerR">
		                    ...
		                    <div class="mis-srh-layout">
								...
								<@cf.form id="updateTeachersForm" action="${ctx}/cms_teachers/${teacher.id}" method="put" saveCallback="redirectEditContent">
		                        <ul class="mis-ipt-lst">
		                                ...
		                                <div class="mis-ipt-row">
		                                    ...
		                                    <div class="tc">
		                                        <div class="mis-ipt-mod">
		                                            <input type="text" name="fullName" value="${teacher.fullName!}" class="mis-ipt">                                            
		                                        </div>
		                                    </div>
		                                </div>
		                            </li>
		                            <li class="item">
		                                <div class="mis-ipt-row">
		                                    ...
		                                    <div class="tc">
		                                        <div class="mis-ipt-mod">
		                                            <input type="text" name="eduBackground" value="${teacher.eduBackground!}"  class="mis-ipt">
		                                        </div>
		                                    </div>
		                                </div>
		                            </li>
		                            <li class="item">
		                                <div class="mis-ipt-row">
		                                    ...
		                                    <div class="tc">
		                                        <div class="mis-ipt-mod">
		                                            <input type="text" name="jobTitle" value="${teacher.jobTitle!}" class="mis-ipt">
		                                        </div>
		                                    </div>
		                                </div>
		                            </li>
		                            <li class="item">
		                                <div class="mis-ipt-row">
		                                    ...
		                                    <div class="tc" id="imageDiv">
												...
												<@ui.uploadImageFtl divId="imageDiv" relationId='${teacher.id}' paramName="fileInfo" paramType="entity" fileNumLimit=1 />
		                                    </div>
		                                </div>
		                            </li>
		                            <li class="item">
		                                <div class="mis-ipt-row">
		                                    ...
		                                    <div class="tc">
		                                        <div class="mis-ipt-mod">
													<input type="text" name="position" value="${teacher.position!}" class="mis-ipt">
		                                        </div>
		                                    </div>
		                                </div>
		                            </li>		                            
		                            ...
		                            <li class="item w1">
							            <div class="mis-ipt-row">
							                ...
							                <div class="tc">
							                	<div class="mis-ipt-mod">
							                    	<textarea id="editor" style="width: 60%; height: 250px;"  name="personalProfile" >${teacher.personalProfile!}</textarea>
							                 	</div>
							                 </div>
							             </div>
							          </li>
