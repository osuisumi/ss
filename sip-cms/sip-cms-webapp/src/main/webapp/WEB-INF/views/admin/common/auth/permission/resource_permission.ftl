...
<@lo.layout jsArray=jsArray>
		<div class="mis-index-wrap">
			<div class="mis-column-innerBox mis-block-cont">
					...
					<@authPermissionsDirective page=param_page!"1" size=param_size!"10" relationId=resourceId  >
					<div class="mis-column-innerR">
							...
							<@cf.form id="${formId}" action="${ctx}/auth_permissions/resource_permissions/${resourceId!}" method="get">
						...
						<script type="text/javascript">	
								function openCreatePermission(){
									 mylayerFn.open({
							            ...
							            type: 2,
							            title: '新增权限操作',
							            content: '${ctx}/auth_permissions/create/${resourceId!}',
										area: [600,400],
							            zIndex: 19999
							        });
								}				
								function editForm(data){
									...
									if(value!=''){
										mylayerFn.open({
								            ...
								            type: 2,
								            title: '修改权限操作',
								            content: '${ctx}/auth_permissions/'+value+'/edit',
											area: [600,600],
								            zIndex: 19999
							        	});
									}
						...
						<script>
							function onClick(event, treeId, treeNode, clickFlag) {
								window.location.href="${ctx}/auth_permissions/resource_permissions/"+treeNode.id;
							}	
						</script>
						<#import "../resource/tree_click.ftl" as tc> 
