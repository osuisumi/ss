<#assign jsArray=["${ctx}/js/ztree/js/jquery.ztree.core.min.js","${ctx}/js/ztree/js/jquery.ztree.exedit.min.js"]/>
<#import "../../include/layout.ftl" as lo> 
<@lo.layout jsArray=jsArray>
		<div class="mis-index-wrap">
                <div class="mis-mod">
                    <div class="mis-mod-tt">
                        <h2 class="tt t1"><span>权限资源信息</span></h2>
                    </div>
	...
	function beforeEditName(treeId, treeNode) {
	    ...
	    mylayerFn.open({
	            ...
	            type: 2,
	            title: '修改权限资源',
	            content: '${ctx}/auth_resources/'+treeNode.id+"/edit",
				area: [600,600],
	            zIndex: 19999
	        });
	...
	function beforeRemove(treeId, treeNode) {
	    ...
	    if(treeNode.isParent){
	    	alert("该权限资源下存在子权限资源，请先删除子权限资源！");
	    	return false;
	    }else{
	    	confirm("确认删除 " + treeNode.name + " 吗？",function(){
	    		$.ajaxDelete("${ctx}/auth_resources/"+treeNode.id,"",function(data){
	...
	function addHoverDom(treeId, treeNode) {
	    ...
	    var addStr = "<span class='button add' id='addBtn_" + treeNode.tId
	        + "' title='新增权限资源' onfocus='this.blur();'></span>";
	    sObj.after(addStr);
	    ...
	    if (btn) btn.bind("click", function(){
	        ...
	        mylayerFn.open({
	            ...
	            type: 2,
	            title: '新增权限资源',
	            content: '${ctx}/auth_resources/create?pid='+treeNode.id,
				area: [600,600],
	            zIndex: 19999
	        });
	        return false;
