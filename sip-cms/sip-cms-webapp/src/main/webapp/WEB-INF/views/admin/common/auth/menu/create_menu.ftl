		...
		<@fl.form id="createMenuForm" action="${ctx}/auth_menus" method="post">
		...
		<@srp.selectResourcePermission  onClick="selectResourcePermission" resourcePermissionInputId="resourcePermission" resourcePermissionInputName="permission" resourcePermissionContentId="resourcePermissionZtreeContent" >
			<script>
