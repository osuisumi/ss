					...
					<div class="mis-column-innerR">
			                    ...
			                    <div class="mis-table-layout">
			                        ...
			                        <div class="mis-opt-row">
			                            <div class="mis-opt-mod fl">
			                                <a href="${ctx}/cms_articles/create?channelId=${channel.id}" class="mis-btn mis-inverse-btn"><i class="mis-add-ico"></i>新建</a>
						...
						<script type="text/javascript">					
								function editForm(data){
									...
									if(value!=''){
										if(data!=undefined&&data!=''){
											window.location.href="${ctx}/cms_articles/"+value+"/edit?"+data;
										}else{
								...
								function topArticle(id){
										$.ajaxPut('${ctx}/cms_articles/'+id, "isTop=Y", function(){
								    		$("#${formId}").submit();
										});
								}
								
								function cancelTopArticle(id){
										$.ajaxPut('${ctx}/cms_articles/'+id, "isTop=N", function(){
								    		$("#${formId}").submit();
										});
								}
