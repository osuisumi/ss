...
<@lo.layout jsArray=jsArray>
		<div class="mis-index-wrap">
			<div class="mis-column-innerBox mis-block-cont">
					...
					<@authPermissionsDirective page=param_page!"1" size=param_size!"10" channelId=channel.id state=param_state!""  title=param_title!"" isTop=param_isTop!"">
					<div class="mis-column-innerR">
						...
						<script>
							function onClick(event, treeId, treeNode, clickFlag) {
								window.location.href="${ctx}/auth_permissions/resource_permission/"+treeNode.id;
							}	
						</script>
