 ...
 */
@Component
public class VisualThemeSetListDirective implements TemplateDirectiveModel{
	@Resource
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<VisualThemeSet> visualThemeSets = visualThemeSetService.findVisualThemeSets(parameter,pageBounds);
		if(pageBounds != null){
			PageList pageList = (PageList)visualThemeSets;
			env.setVariable("paginator" , new DefaultObjectWrapper().wrap(pageList.getPaginator()));
		}
		env.setVariable("visualThemeSetList",  new DefaultObjectWrapper().wrap(visualThemeSets));
